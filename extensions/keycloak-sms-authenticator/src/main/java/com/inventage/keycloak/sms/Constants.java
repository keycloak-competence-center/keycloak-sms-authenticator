...
public class Constants {
    ...
    public static final String ENTER_NUMBER_TEMPLATE_NAME = "keycloak-sms-authenticator_sms-config.ftl";

    // Freemarker template for rendering the "SMS Code" UI
    public static final String SMS_CHALLENGE_TEMPLATE_NAME = "keycloak-sms-authenticator_login-sms.ftl";
